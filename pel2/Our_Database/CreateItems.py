...
def create_item_csv():
    ...
    for item in item_name:
        ...
        description = "Nombre: " + \
            str(item) + "   Tipo: " + str(type_item) + \
            "   Precio: " + str(price)

        item = {'Codigo de barras': barcode, 'Nombre': item,
                'Tipo': type_item, 'Descripcion': description, 'Precio': price}
    ...
    df.to_csv('./Our_Database/GeneratedCSV/item_data.csv',
              sep=';', index=False)
