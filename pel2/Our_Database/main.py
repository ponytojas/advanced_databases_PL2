...
from Our_Database.CreateEmployees import create_employee_csv as create_employees
from Our_Database.CreateItems import create_item_csv as create_items
from Our_Database.CreateStores import create_store_csv as create_stores
from Our_Database.CreateStockItem import create_stock_item_csv as create_stock_items
from Our_Database.CreateTickets import create_tickets_csv as create_tickets
from Our_Database.CreateStockTicket import create_stock_tickets_csv as create_stock_ticket
...
def create_database():
    ...
    print("--- %s seconds --- Total time to create the database" % (time.time() - start_time))
...
def create_stock_and_tickets(connection):
...
def create_stock_tickets(connection):
    ...
    create_stock_ticket(connection)
